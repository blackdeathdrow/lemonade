...
export interface LayoutSettings {
  ...
  leftPanelView: 'models' | 'marketplace' | 'backends' | 'sessions' | 'settings';
...
export const mergeWithDefaultSettings = (incoming?: Partial<AppSettings>): AppSettings => {
  ...
  if (rawLayout && typeof rawLayout === 'object') {
    ...
    if (rawLayout.leftPanelView === 'models' || rawLayout.leftPanelView === 'marketplace' || rawLayout.leftPanelView === 'backends' || rawLayout.leftPanelView === 'sessions' || rawLayout.leftPanelView === 'settings') {
